...
echo "<a href='nopub.php'>$k</a>";}}
        ...
        <div class="new_post"><a href="/eadmin/?to=newpost">Ավելացնել լուր</a></div>
<div class="new_post"><a href="/eadmin/?to=newtag">Ավելացնել հանգուցային բառ</a></div>
<div class="new_post"><a href="/eadmin/poll_admin">Փոխել հարցումը</a></div>
<div class="postBox">
	<div class="title">
		<div class="tab tab1">Վերնագիր</div>
		<div class="tab tab2">Հրապ.</div>
		<div class="tab tab3">Գրանց. ամս.</div>
	...
	<div class="table">
        ...
        <?php 
$newscatk = mysql_query("SELECT * FROM content where state='0' ",$db);
if (!$newscatk){
...
$newscat = mysql_query("SELECT * FROM content where state='0' ORDER BY id DESC LIMIT $stat,25 ",$db);
if (!$newscat){
...
printf (" <div class='tab tab1'><a href='../view_post.php?id=%s' target='_blank' >%s</a></div>
        ...
        <div class='tab tab5'><a href='edit.php?id=%s' target='_blank'>խմբագրել</a><a href='' onClick='return confirm('Իսկապե՞ս ջնջել:');'>ջնջել</a></div>
        <div class='clear'></div></div>
    <div class='row even '>",$newscat_row["id"],$newscat_row["title"],$pub,$newscat_row["created"],$newscat_row["hits"],$newscat_row["id"],$newscat_row["title"],$newscat_row["id"]);}
	 
while ($newscat_row = mysql_fetch_array($newscat)); }
else{ echo "sxal"; exit(); } 

if ($page<5 and $page>1) {printf("<div class='pages'><a href='nopub.php?page=%s' class='next'>&lt;&lt;</a>
<a class='pageLinks activePage'>%s</a>",$page-1,$page);}			   
else if ($page>5) {printf("<div class='pages'><a href='nopub.php?page=%s' class='next'>&lt;&lt;</a>
...
do {
   printf("<a href='nopub.php?page=%s' class='pageLinks'>%s</a>",$page,$page);
   $page++;
   $stat=$stat+25; 
   $k++;
}
...
if ($stat<$p)
{ printf("<a href='nopub.php?page=%s' class='next'>&gt;&gt;</a>",$page);}	}	?>
