  ...
  protected function onDetail(){
    ...
    if (FileManagerUtility::startsWith($mime, 'image/')) {
      ...
      $content = '<dl>
        ...
        <h2>${preview}</h2>
        <a href="../../../../epanel/gal/Assets/Connector/'.$url.'" data-milkbox="preview"><img src="../../../../epanel/gal/Assets/Connector/' . $this-&gt;options['thumbnailPath'] . $this-&gt;getThumb($this-&gt;normalize($file)).$randomImage.'" class="preview" alt="preview" /></a>
        ';
    // text preview
    ...
    // zip
      ...
      foreach ($getid3->info['zip']['files'] as $name => $size){
        ...
        $out[($dir) ? 0 : 1][$name] = '<li><a><img src="../../../../epanel/gal/Assets/Connector/'.$this-&gt;getIcon($name,true).'" alt="" /> ' . $name . '</a></li>';
      }
      natcasesort($out[0]);
      natcasesort($out[1]);
    ...
    // swf
      ...
      $content = '<dl>
        ...
        <h2>${preview}</h2>
        <div class="object">
          <object type="application/x-shockwave-flash" data="../../../../epanel/gal/Assets/Connector/'.str_replace($_SERVER['DOCUMENT_ROOT'],'',$file).'" width="500" height="400">
            <param name="scale" value="noscale" />
            <param name="movie" value="../../../../epanel/gal/Assets/Connector/'.str_replace($_SERVER['DOCUMENT_ROOT'],'',$file).'" />
          </object>
        </div>';
    // audio
      ...
      $content = '<dl>
        ...
        <h2>${preview}</h2>
        <div class="object">
          <object type="application/x-shockwave-flash" data="../../../../epanel/gal/Assets/Connector/' . $this-&gt;options['assetBasePath'] . '/dewplayer.swf" width="200" height="20" id="dewplayer" name="dewplayer">
            <param name="wmode" value="transparent" />
            <param name="movie" value="../../../../epanel/gal/Assets/Connector/' . $this-&gt;options['assetBasePath'] . '/dewplayer.swf" />
