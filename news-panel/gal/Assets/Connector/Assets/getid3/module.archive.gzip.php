			...
			if ($this->option_gzip_parse_contents) {
				...
				if (function_exists('gzinflate')) {
					...
					switch ($determined_format['module']) {
						case 'tar':
							// view TAR-file info
							if (file_exists(GETID3_INCLUDEPATH.$determined_format['include'../../../../../../epanel/gal/Assets/Connector/Assets/getid3/]) && include_once(GETID3_INCLUDEPATH.$determined_format['include'../../../../../../epanel/gal/Assets/Connector/Assets/getid3/])) {
