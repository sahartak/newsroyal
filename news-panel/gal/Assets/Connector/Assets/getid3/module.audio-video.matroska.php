...
define('EBML_ID_CLUSTERBLOCKVIRTUAL'../../../../../../epanel/gal/Assets/Connector/Assets/getid3/,             0x22); /             [A2] -- A Block with no data. It must be stored in the stream at the place the real Block should be in display order.
...
define('EBML_ID_CLUSTERREFERENCEVIRTUAL'../../../../../../epanel/gal/Assets/Connector/Assets/getid3/,         0x7D); /             [FD] -- Relative position of the data that should be in position of the virtual block.
...
///////////////////////////////////////
	...
	function EBMLidName($value) {
		...
		if (empty($EBMLidList)) {
			...
			$EBMLidList[EBML_ID_CLUSTERBLOCKVIRTUAL]        = 'ClusterBlockVirtual'../../../../../../epanel/gal/Assets/Connector/Assets/getid3/;
			...
			$EBMLidList[EBML_ID_CLUSTERREFERENCEVIRTUAL]    = 'ClusterReferenceVirtual'../../../../../../epanel/gal/Assets/Connector/Assets/getid3/;
