...
?>
       ...
       <form action="upuser.php" method="post" name="userp">
      <label><p>Լոգին<br>
       <input name="login" type="text" size="30" maxlength="50"></p>
       </label>
        <label><p>Հին գաղտնաբառը<br>
       <input name="pas1" type="password" size="30" maxlength="50"></p>
       </label>
       <label><p>Նոր գաղտնաբառը<br>
       <input name="pas2" type="password" size="30" maxlength="50"></p>
       </label>
       <input name="" type="submit" value="Հաստատել">
       </form>
