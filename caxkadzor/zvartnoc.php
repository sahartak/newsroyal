...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Զվարթնոց հանգստյան տուն</title>
    ...
    <?php include"include/header.php";?>
			...
			<div class="bodyLeft clearfix">
				<article class="articleShow clearfix">
               				<h1 align="center">Զվարթնոց հանգստյան տուն</h1>
					<div class='clearfix'>
						
						<br><div class="fb-like" data-href="http://caxkadzor.newsroyal.com/zvartnoc.php" data-width="300" data-height="100" data-colorscheme="light" data-layout="button_count" data-action="recommend" data-show-faces="true" data-send="false"></div>
					</div>
...
?>        
					...
					<div class="articleTools">
						...
						<div class="share"><a href="http://www.facebook.com/sharer.php?u=caxkadzor.newsroyal.com/zvartnoc.php&t=Հանգիստ Ծաղկաձորում բոլորի համար 3 օրվա (3 օր 2 գիշեր) համար վճարելով ԸՆԴԱՄԵՆԸ 16.500 դրամ:" target="_blank"><img src="img/sharer.png" /></a></div>
				  </div>
